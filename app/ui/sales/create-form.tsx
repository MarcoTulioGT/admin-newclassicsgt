'use client';
import { DepartamentField, BoxField } from '@/app/lib/definitions';
...
export default function Form({ departamentos , boxes}: { departamentos: DepartamentField[] , boxes: BoxField[] }) { 
  //console.log(departamentos)
  let depto = departamentos.map(function(element, index, array){
    return  element.departamento
   });

   let municipio = departamentos.map(function(element, index, array){

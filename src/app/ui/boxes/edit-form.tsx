            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={box.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="inprogress"
                  defaultChecked={box.status === 'inprogress'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="inprogress"
                ...
                >
                  Inprogress <CheckIcon className="h-4 w-4" />
                </label>
              </div>
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="delivery"
                  defaultChecked={box.status === 'delivery'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="delivery"
                ...
                >
                  Delivery <CheckIcon className="h-4 w-4" />
                </label>
              </div>
            </div>
